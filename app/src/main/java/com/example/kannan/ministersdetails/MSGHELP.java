...
public class MSGHELP extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "ICT.db";
    public static final String TABLE_NAME = "MESSAGE1";
    ...
    public MSGHELP(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT,MESSAGE TEXT NOT NULL,DATE TEXT NOT NULL)");
    ...
    public boolean insertData(String t1, String date) {
